								...
								<div className="card-body p-0 ">
									...
									<div className="mailbox-read-message">
										...
										<p className="mb-2">
											...
											majelis yang dibutuhkan yakni sebanyak 72 orang yang terdiri dari 42 Penatua
											dan 30 Diaken, maka akan dilaksanakan pemilihan majelis pada tanggal ...
											2021, setelah ibadah hari minggu. Harap bapak/ibu bisa mengikuti kembali.
										</p>
										<p className="mb-2">
